...
function updateClientDetails() {
    $('.clientCompany').html($('.clientDetails option:selected').data('company'));
    $('.clientName').html($('.clientDetails option:selected').data('first-name')+' '+$('.clientDetails option:selected').data('last-name'));
    $('.clientAddress').html($('.clientDetails option:selected').data('address'));
    $('.clientId').html($('.clientDetails option:selected').data('clientid'));
}
...
$('.proposal.admin').each(function() {
    ...
    $('.addEstimate').live('click', function() {
        ...
        jQuery.facebox({ajax: proposalGetEstimates});
    ...
    $('.sidebar .clientDetails').change(updateClientDetails);
